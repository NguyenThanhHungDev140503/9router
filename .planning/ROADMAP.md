...
| 3 | Format-Aware Inbound Injection | Tiêm tự động Tool Schemas và Skill Prompts đa định dạng (OpenAI, Claude, Gemini, Responses) | MCP-INJECT-01, MCP-INJECT-02, MCP-INJECT-03, MCP-INJECT-04 | 4 |
