...
export function buildRequestDetail(base, overrides = {}) {
  return {
    ...
    userId: base.userId || overrides.userId || undefined,
...
export function saveUsageStats({ provider, model, tokens, connectionId, apiKey, endpoint, userId, label = "USAGE", silent = false }) {
